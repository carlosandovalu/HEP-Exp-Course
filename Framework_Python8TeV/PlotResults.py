...
from Plotting import Paintable as Paintable
from Plotting import Depiction as Depiction
from Plotting import Database  as Database
import importlib
...
def DrawPlot(configuration, histlocation):
    ...
    canvas.SaveAs("results/" + histlocation+ ".png")  
